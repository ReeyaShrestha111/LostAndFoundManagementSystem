...
<%
    ...
    List<ItemModel> allItems = (List<ItemModel>) request.getAttribute("allItems");
    int totalUsers   = (int) request.getAttribute("totalUsers");
    int totalItems   = (int) request.getAttribute("totalItems");
    int pendingItems = (int) request.getAttribute("pendingItems");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar">
    ...
    <div class="navbar-nav">
        ...
        <a href="<%= request.getContextPath() %>/admindashboard" class="active">Dashboard</a>
